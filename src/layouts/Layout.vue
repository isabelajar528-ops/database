<template>
    <div :class="classes">
        ...
        <header v-if="!$root.isMobile" class="d-flex flex-wrap justify-content-center py-3 mb-3 border-bottom">
            ...
            >
                <img class="kuma-brand-logo me-2 ms-4" width="40" height="40" src="/lemhannas-logo.jpeg" alt="Lemhannas RI" />
                <span class="fs-4 title">NOC Lemhannas</span>
            </router-link>
    ...
    <a href="/noc" class="nav-link">
        <font-awesome-icon icon="chart-bar" /> NOC
    </a>
</li>
                <li v-if="$root.loggedIn" class="nav-item me-2">
        ...
        <header v-else class="d-flex flex-wrap justify-content-center pt-2 pb-2 mb-3">
            <router-link to="/dashboard" class="d-flex align-items-center text-dark text-decoration-none">
                <img class="kuma-brand-logo" width="40" height="40" src="/lemhannas-logo.jpeg" alt="Lemhannas RI" />
                <span class="fs-4 title ms-2">NOC Lemhannas</span>
            </router-link>
        </header>
